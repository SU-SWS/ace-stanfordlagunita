...
namespace Drupal\Tests\csp_profile\Kernel\EventSubscriber;
...
use Drupal\csp_profile\EventSubscriber\StanfordProfileEventSubscriber;
...
class EventSubscriberTest extends KernelTestBase {
   ...
   *
   * @var \Drupal\csp_profile\EventSubscriber\StanfordProfileEventSubscriber
   */
