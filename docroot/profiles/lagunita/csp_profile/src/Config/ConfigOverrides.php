...
namespace Drupal\csp_profile\Config;
 ...
 *
 * @package Drupal\csp_profile\Config
 */
  ...
  public function loadOverrides($names) {
    ...
    if (in_array('system.site', $names)) {
      $overrides['system.site']['page'] = [
        403 => $this->state->get('csp_profile.403_page'),
        404 => $this->state->get('csp_profile.404_page'),
        'front' => $this->state->get('csp_profile.front_page'),
      ];
    }
