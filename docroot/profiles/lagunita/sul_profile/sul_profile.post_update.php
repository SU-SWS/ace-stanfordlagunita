 ...
 */
function sul_profile_post_update_event_pages() {
 ...
 */
function sul_profile_post_update_header_links_block() {
 ...
 * Create new header link block for the active theme.
 */
function sul_profile_post_update_unpublished_site_banner() {
  $theme = \Drupal::config('system.theme')->get('default');
  if (in_array($theme, [
    'stanford_basic',
    'minimally_branded_subtheme',
