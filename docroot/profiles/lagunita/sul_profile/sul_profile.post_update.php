...
function  sul_profile_removed_post_updates() {
  return [
    ...
    'sul_profile_post_update_event_pages' => '12.0.0',
    'sul_profile_post_update_header_links_block' =>'12.0.0',
    'sul_profile_post_update_unpublished_site_banner' =>'12.0.0',
  ];
}
 ...
 */
function sul_profile_post_update_rabbit_hole_block() {
