...
use Drupal\sul_profile\EventSubscriber\SulProfileEventSubscriber;
...
class EventSubscriberTest extends KernelTestBase {
   ...
   *
   * @var \Drupal\sul_profile\EventSubscriber\SulProfileEventSubscriber
   */
  ...
  public function setup(): void {
    ...
    $this->eventSubscriber = new TestSulProfileEventSubscriber($file_system, $client, $logger_factory, $messenger);
  ...
  public function testConsumerSecretRandomized() {
    $this->assertContains('onContentImport', SulProfileEventSubscriber::getSubscribedEvents());
 ...
 * {@inheritDoc}
 */
class TestSulProfileEventSubscriber extends SulProfileEventSubscriber {
