...
namespace Drupal\Tests\supress\Kernel\EventSubscriber;
...
use Drupal\supress\EventSubscriber\PressProfileEventSubscriber;
...
class EventSubscriberTest extends KernelTestBase {
   ...
   *
   * @var \Drupal\supress\EventSubscriber\PressProfileEventSubscriber
   */
  ...
  public function setup(): void {
    ...
    $this->eventSubscriber = new TestPressProfileEventSubscriber($file_system, $client, $logger_factory, $messenger);
  ...
  public function testConsumerSecretRandomized() {
    $this->assertContains('onContentImport', PressProfileEventSubscriber::getSubscribedEvents());
 ...
 * {@inheritDoc}
 */
class TestPressProfileEventSubscriber extends PressProfileEventSubscriber {
