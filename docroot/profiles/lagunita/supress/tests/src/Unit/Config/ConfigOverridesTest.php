...
namespace Drupal\Tests\supress\Unit\Config;
...
use Drupal\supress\Config\ConfigOverrides;
 ...
 * @coversDefaultClass \Drupal\supress\Config\ConfigOverrides
 */
class ConfigOverridesTest extends UnitTestCase {

  /**
   * @var \Drupal\supress\Config\ConfigOverrides
   */
