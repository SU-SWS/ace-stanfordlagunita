...
namespace Drupal\Tests\summer_profile\Kernel\EventSubscriber;
...
use Drupal\summer_profile\EventSubscriber\SummerProfileEventSubscriber;
...
class EventSubscriberTest extends KernelTestBase {
   ...
   *
   * @var \Drupal\summer_profile\EventSubscriber\SummerProfileEventSubscriber
   */
  ...
  public function setup(): void {
    ...
    $this->eventSubscriber = new TestSummerProfileEventSubscriber($file_system, $client, $logger_factory, $messenger);
  ...
  public function testConsumerSecretRandomized() {
    $this->assertContains('onContentImport', SummerProfileEventSubscriber::getSubscribedEvents());
 ...
 * {@inheritDoc}
 */
class TestSummerProfileEventSubscriber extends SummerProfileEventSubscriber {
