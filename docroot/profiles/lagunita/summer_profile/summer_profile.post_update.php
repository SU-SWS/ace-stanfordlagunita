...
function summer_profile_removed_post_updates() {
  return [
    ...
    'summer_profile_post_update_event_pages' => '12.0.0',
    'summer_profile_post_update_header_links_block' =>'12.0.0',
    'summer_profile_post_update_unpublished_site_banner' =>'12.0.0',
  ];
}
 ...
 */
function summer_profile_post_update_rabbit_hole_block() {
